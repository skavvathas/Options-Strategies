...
# Payoff per contract
payoff = ((S - S0) - premium + np.maximum(K - S, 0)) * contract_size
...
plt.axvline(S0, linestyle=':', label="Stock Price (275)")
...
# Titles
plt.title("Protective Put Payoff per Contract (100 shares)")
